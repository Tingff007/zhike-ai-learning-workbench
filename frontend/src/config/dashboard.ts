...
export const dashboardExperienceConfig = {
  ...
  copy: {
    pageBadge: '心流驾驶舱',
    pageTitle: '今天只做下一步',
    pageSubtitle: '隐藏冷启动大盘，保留一个主按钮、一条关卡线和一个会安排任务的 AI 私教。',
    ...
    heroDescription:
      'AI 已为你准备好今天最适合的 {stepCount} 个轻量任务，预计耗时 {minutes} 分钟。先完成第一关，后面的内容会自动解锁。',
    assistantTitle: 'AI 伴学助手',
    assistantDescription: '我会把后台检索、资源生成和难度调整收起来，只把下一步递给你。',
    guideTitle: '关卡式任务流',
    guideDescription: '讲义、题单、实验都塞进同一条线里，用户只需要一路下一步。',
    ...
    progressDescription: '只保留对下一步有帮助的信息。',
  ...
  coach: {
    riskKeys: ['risk', '风险'],
    coldStartLines: [
      '我已经把今天的内容压成 {stepCount} 个轻量任务，先从第一关开始就好。',
